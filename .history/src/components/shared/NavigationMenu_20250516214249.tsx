...
const NavigationMenu: React.FC = () => {
  ...
  const menuItems = ['Home', 'Experience', 'Skill', 'Project', 'About Me'];
  ...
  return (
    <>
      ...
      <div style={{
        ...
        background: isMobile ? '#2c1810' : 'rgba(44, 24, 16, 0.95)',
        transform: isMobile ? `translateX(${isOpen ? '0' : '-100%'})` : 'none',
        transition: 'transform 0.3s ease',
        zIndex: 1000,
        boxShadow: isMobile ? (isOpen ? '2px 0 5px rgba(0,0,0,0.3)' : 'none') : '0 2px 5px rgba(0,0,0,0.2)',
